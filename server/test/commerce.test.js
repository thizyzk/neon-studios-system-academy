...
test("commerce catalog keeps canonical server-side BRL prices", () => {
  assert.deepEqual(
    ...
    [
      { id: "plus-monthly", amountCents: 12990, energy: undefined },
...
test("Stripe prices must match the public amount, currency and billing mode", () => {
  ...
  assert.equal(stripePriceMatchesProduct(plus, { active: true, currency: "brl", unit_amount: 12990, type: "recurring", recurring: { interval: "month" } }), true);
